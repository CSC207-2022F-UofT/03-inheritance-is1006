...
//    private String contents[] ??? why is this not working correctly
    /*
    ...
    public String popItem(){
        ...
        String[] new_array = new String[this.numberOfContents - 1];
//        i = index of original, n = index of new

        for (int i = 0, n = 0; i < (this.numberOfContents - 1); i++){
//            for both indexes are at 0, and i is less than the length-1 of the new list (since we are getting rid of
//            one item (the last to be removed from the bag)
            new_array[n++] = this.contents[i];
        }
